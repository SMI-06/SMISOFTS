...
// For Contact
window.onload = function () {
  const contact = document.getElementById("maphidden");
  const cont_heading = document.getElementById("cont_heading");
  const isHomePage =
    window.location.pathname === "/" ||
    window.location.pathname.endsWith("index.html");
  if (isHomePage && contact) {
    contact.style.display = "none";
    // cont_heading.style.display = "block";
  } else if (contact) {
    cont_heading.style.display = "none";
